/*
 * @file find_objectpoint_by_orientation.hpp
 * @author Kosei SHINO
 * @date 2024/9/30
 */
...
#include "hdk/find_objectpoint_by_orientation_config.hpp"
...
namespace hdk {
	namespace objectpoint_finder {
		...
		bool find_objectpoint_in_direction(gnd::path::path_net_area_and_speed_limited &path_net,
            double x, double y, double theta, double max_distance, double angle_threshold,
            const char *objectpoint_name_destination, char *objectpoint_name);
